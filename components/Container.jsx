...
export default function Container(props) {
  ...
  const meta = {
    title: 'Chris Shockley - Software Engineer, Writer, Traveler',
  ...
  return (
    <div className='bg-white dark:bg-black'>
      <Head>
        ...
        <meta
          property='og:url'
          content={`https://cishockley.com${router.asPath}`}
        />
        <link rel='canonical' href={`https://cishockley.com${router.asPath}`} />
        <meta property='og:type' content={meta.type} />
        <meta property='og:site_name' content='Chris Shockley' />
        <meta property='og:description' content={meta.description} />
        <meta property='og:title' content={meta.title} />
        <meta property='og:image' content={meta.image} />
        <meta name='twitter:card' content='summary_large_image' />
        <meta name='twitter:site' content='@c_shocksr' />
