...
type IconProps = SVGProps<SVGSVGElement> & {
  /** Accessible name; rendered in `<title>` and aria-label */
  title?: string
}

const TwitterIcon = ({ title = "Twitter", ...props }: IconProps) => (
  <svg
    role="img"
    aria-label={title}
    viewBox="-143 145 512 512"
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor" // lets you color with CSS
    {...props} // width, height, className, etc.
  >
    <title>{title}</title>
    <path
