    ...
    <>
        ...
        {filteredPosts.map((post) => (
          ...
          >
            ...
            <CardContent className="flex-1 p-6">
              ...
              <p className="text-slate dark:text-muted-foreground mb-4">{post.excerpt}</p>
      ...
      {filteredPosts.length === 0 && (
        <div className="text-center py-12">
          <h3 className="text-xl font-medium mb-2 text-charcoal dark:text-foreground">No articles found</h3>
