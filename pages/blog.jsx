...
export default function Blog({ posts }) {
  ...
  return (
    <Container
      ...
      description='Thoughts and experiences in my journey to becoming a software engineer'
    >
      <div className='flex flex-col justify-center items-start max-w-2xl mx-auto mb-16'>
        ...
        <p className='text-gray-600 dark:text-gray-400 mb-4'>
          {`I am a new developer. For the past year and a half I have been on a journey that has had a lot of ups and downs.  These blogs follow that journey from today forth. Come grow with me!
